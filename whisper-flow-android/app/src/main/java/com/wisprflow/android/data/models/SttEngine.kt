package com.wisprflow.android.data.models
...
enum class SttEngine(
    ...
    GROQ(
        ...
        description = "Blazing fast transcription with Whisper Large v3 on Groq LPU. Recommended for real-time Wispr experience.",
        requiresApiKey = true
    ),
    OPENAI(
